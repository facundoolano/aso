...
function build (store) {
  ...
  */
  const similar = (appId) => store.similar({appId, fullDetail: true});
  ...
  */
  function search (keywords) {
    ...
    return getSearchKeywords(keywords).then(getAppsFromKeywords);
  }
